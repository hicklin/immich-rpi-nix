...
1. Follow [setup step 1](../setup/1-encrypt-drive.md) to encrypt the external drive.
...
6. [Migrate your photos and videos](../management/1-migrating-photos.md).
...
8. Setup the RPi server
   ...
   2. Setup immich following [setup step 3, Raspberry Pi](../setup/3-immich.md#raspberry-pi) up to and including step 7.
      > [!IMPORTANT]
      > Use the same `DB_PASSWORD` used in step 4 above.
   3. Restore the database following [Recovery From Cloud Storage](../disaster-recovery.md#recovery-from-cloud-storage) steps 7 to 9.
   4. Configure backups following [setup step 4](../setup/4-backups.md)
   5. Setup remote access following [setup step 5](../setup/5-remote-access.md)
